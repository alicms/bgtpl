...
<div class="am-g">
    ...
    <div class="am-u-lg-12 am-u-md-12 am-u-sm-centered">
        ...
        <form method="post" class="am-form am-center" action="admin-index.php">
            <div>请按要求填写,打<sapn class="star">*</sapn>必填<a href="login.php" style="float: right;font-size: 10px;font-family: 'Microsoft Yahei;';">立即登录</a></div>
            ...
            <input class="am-cf am-btn am-btn-primary am-btn-sm" type="submit" style="width: 100%" value="注册">
